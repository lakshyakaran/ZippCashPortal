                        ...
                        <div class="bs-example" data-example-id="simple-jumbotron">
                          <div class = "form-horizontal">
                            <div class="form-group">
                              <label class="control-label col-md-2 col-sm-2 col-xs-2" style = "text-align:left;">User ID</label>
                              <div class="col-md-10 col-sm-10 col-xs-10">
                                <p style = "padding-top:8px;"><?php echo $account_details->login_id; ?></p>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-2 col-sm-2 col-xs-2" style = "text-align:left;">Wallet ID</label>
                              <div class="col-md-10 col-sm-10 col-xs-10">
                                <p style = "padding-top:8px;"><?php echo $account_details->wallet_id; ?></p>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-2 col-sm-2 col-xs-2" style = "text-align:left;">Name</label>
                              <div class="col-md-10 col-sm-10 col-xs-10">
                                <p style = "padding-top:8px;"><?php echo $account_details->name; ?></p>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-2 col-sm-2 col-xs-2" style = "text-align:left;">Available Balance</label>
                              <div class="col-md-10 col-sm-10 col-xs-10">
                            ...
                            <?php if(!isset($_GET['user_id'])){ ?>
                              <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-2" style = "text-align:left;">Total Asset</label>
                                <div class="col-md-10 col-sm-10 col-xs-10">
                            ...
                            <?php } ?>
                            <div class="form-group">
                              <label class="control-label col-md-2 col-sm-2 col-xs-2" style = "text-align:left;">Currency</label>
                              <div class="col-md-10 col-sm-10 col-xs-10">
