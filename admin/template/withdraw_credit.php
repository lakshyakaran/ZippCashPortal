        ...
        <div class="row">
          <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                <form id="withdraw_credit_form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                  <div id = "withdraw_credit_error" style = "display: none;" class="alert alert-danger alert-dismissible fade in" role="alert">
                  </div>
                  <div id = "withdraw_credit_success" style = "display: none;" class="alert alert-success alert-dismissible fade in" role="alert">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="debit_amount" class="form-control col-md-7 col-xs-12" type="text" name="middle-name">
                    </div>
                  </div>
                  <div class="ln_solid"></div>
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      <button type="submit" id = "withdraw_credit" class="btn btn-success" disabled="true">Withdraw</button>
