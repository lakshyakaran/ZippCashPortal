        ...
        <div class="row">
          <div class="col-md-6 col-sm-12 col-xs-12">
            <div class="x_panel">
              ...
              <div class="x_content">
                <form id="add_credit_form" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                  <div id = "add_credit_error" style = "display: none;" class="alert alert-danger alert-dismissible fade in" role="alert">
                  </div>
                  <div id = "add_credit_success" style = "display: none;" class="alert alert-success alert-dismissible fade in" role="alert">
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      <button type="submit" id = "add_credit" class="btn btn-success" disabled="true">Add Credit</button>
